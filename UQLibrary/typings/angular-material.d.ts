...
declare namespace angular.material {
    ...
    type ThemeColors = 'red' | 'pink' | 'purple' | 'deep-purple' | 'indigo' | 'blue' | 'light-blue' | 'cyan' | 'teal' | 'green' | 'light-green' | 'lime' | 'yellow' | 'amber' | 'orange' | 'deep-orange' | 'brown' | 'grey' | 'blue-grey';
    interface ITheme {
        name: string;
        isDark: boolean;
        colors: IThemeColors;
        ...
        accentPalette(name: ThemeColors, hues?: IThemeHues): ITheme;
        primaryPalette(name: ThemeColors, hues?: IThemeHues): ITheme;
        warnPalette(name: ThemeColors, hues?: IThemeHues): ITheme;
        backgroundPalette(name: ThemeColors, hues?: IThemeHues): ITheme;
